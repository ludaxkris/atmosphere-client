...
PS_Output RenderParticlePS(VS_Output In) {
	...
	PS_Output output;
	output.Color.rgb = float4(tex1D(colorMapTex, 1 - In.Color.a )).rgb * float3(1.2,1.2,1.2);
	output.Color.a = tex2D(MeshTextureSampler, In.DiffuseUV) * In.Color.a * 1.2;
